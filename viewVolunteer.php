    ...
    <!-- end navbar -->
     <!-- Main Links -->
      <div class="volunteer-container">
        <div class="volunteer-function">
            <ul>
                <li><a href="index.html">Home</a></li>
                <li><a href="addUser.html">Add Volunteers</a></li>
        ...
        <div class="user-data">
        <h1 id="viewUsers-Heading">View Volunteers</h1>
      ...
      // Query to get data with row number
        $sql = "SELECT @rownum := @rownum + 1 AS index_number, email FROM volunteer, (SELECT @rownum := 0) r";
        $result = $conn->query($sql);

        // query to select data
        $sql="SELECT name, email,  pwd from volunteer";
        $result = $conn-> query($sql);
